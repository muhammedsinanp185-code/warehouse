...
<head>
    ...
    <style>
        ...
        .form-select option {
            background-color: #0f172a; /* Solid dark background for options to remain legible */
            color: #ffffff;
        }
...
<body>
    ...
    <div class="auth-container">
        ...
        <div style="text-align: center; margin-bottom: 1.5rem;">
            <h2 style="font-size: 2.2rem; font-weight: 800; letter-spacing: 1px; color: var(--text-color); margin: 0;">StockFlow<span style="color: #3b82f6;">.</span></h2>
        </div>
        ...
        <form method="POST" action="/register" style="width: 100%;">
            ...
            <div class="form-group">
                ...
                <div class="select-wrapper">
                    ...
                    <svg class="select-arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" width="16" height="16">
        ...
        <a href="/login" class="register-link" style="margin-top: 1.5rem;">Already have an account? Login here.</a>
    </div>
