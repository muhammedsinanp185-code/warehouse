...
@section('back_link', route('manager.inventory'))
...
@section('content')
            <div class="filters-bar" style="display: flex; gap: 1rem; margin-bottom: 1.5rem; align-items: center; justify-content: flex-end; flex-wrap: wrap;">
                ...
                <form method="GET" action="{{ url()->current() }}" style="display: flex; gap: 0.5rem; align-items: center; flex-wrap: wrap;" id="auditSearchForm">
                ...
                <table class="dashboard-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">{{ $movement->user ? $movement->user->name : 'System' }}</td>
                        </tr>
                        @empty
                        <tr>
