    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="user-icon-circle" style="width: 40px; height: 40px; margin-bottom: 0;">
        ...
        <main class="main-content">
            <div class="topbar">
                <div style="flex: 1;">
                    <h1 style="font-size: 1.5rem; font-weight: 300; letter-spacing: 2px;">DASHBOARD</h1>
                </div>
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 2.5rem; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.1); margin-top: 2rem;">
                <h3 style="font-weight: 500; margin-bottom: 1rem;">System Overview</h3>
                <p style="color: var(--text-muted); line-height: 1.6;">Your dashboard widgets, charts, and tables will populate here. Use the sidebar to navigate to specific modules.</p>
            </div>
        </main>
    </div>
