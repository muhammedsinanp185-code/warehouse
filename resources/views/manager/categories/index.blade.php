...
@section('content')
            <div class="filters-bar" style="display: flex; gap: 1rem; margin-bottom: 1.5rem; align-items: center; justify-content: flex-end; flex-wrap: wrap;">
                <button onclick="openModal('addCategoryModal')" class="form-btn" style="width: auto; padding: 0.6rem 1.2rem; font-size: 0.9rem; border-radius: 6px;">+ Add Category</button>
            </div>
            ...
            <div class="table-container">
                <table class="dashboard-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; border-bottom: none;">
                                <div style="display: inline-flex; gap: 0.25rem;">
                                    <button type="button" class="action-icon" style="color: #3b82f6; padding: 4px;" onclick="openEditCategoryModal({{ $category->id }}, '{{ addslashes($category->name) }}')" title="Edit">
                        ...
                        @empty
                        <tr>
                            <td colspan="3" style="text-align: center; padding: 2rem; color: var(--text-muted);">No categories found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="modal-overlay" id="addCategoryModal">
                <div class="modal-content">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        @csrf
                        <div class="form-group"><input type="text" name="name" class="form-input" placeholder="Category Name" required></div>
                        <button type="submit" class="form-btn" style="margin-top: 1rem;">Save Category</button>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-overlay" id="editCategoryModal">
                <div class="modal-content">
                    ...
                    <form method="POST" id="editCategoryForm">
                        @csrf
                        @method('PUT')
                        <div class="form-group"><input type="text" name="name" id="edit_category_name" class="form-input" placeholder="Category Name" required></div>
                        <button type="submit" class="form-btn" style="margin-top: 1rem;">Update Category</button>
                    </form>
                </div>
            </div>
